...
> = {
  agave: {
    title: 'Agave Hardware Recommendations - Solana HCL',
    description:
      'Hardware recommendations for Agave validator client. Find recommended CPUs, storage solutions, and configuration guides for running Solana validators with Agave.',
    keywords:
      'Solana Agave, Agave validator hardware, Solana validator CPU, Agave storage recommendations',
  },
  frankendancer: {
    title: 'Frankendancer Hardware Recommendations - Solana HCL',
    description:
      'Hardware recommendations for Frankendancer validator client. Find tested CPUs, storage solutions, and performance tuning guides for hybrid Agave/Firedancer setups.',
    keywords:
      'Solana Frankendancer, Frankendancer validator hardware, Solana validator CPU, Frankendancer storage recommendations',
  },
  firedancer: {
    title: 'Firedancer Hardware Recommendations - Solana HCL',
    description:
      'Hardware recommendations for Firedancer validator client. Find high-performance CPUs, storage solutions, and optimization guides for next-generation Solana validators.',
    keywords:
      'Solana Firedancer, Firedancer validator hardware, Solana validator CPU, Firedancer storage recommendations',
  },
};
...
export default function Category() {
  ...
  const seoData = type ? CATEGORY_SEO[type] : null;
        ...
        <section id="baseline" className="mb-12 scroll-mt-20">
          ...
          <div className="md:hidden space-y-4">
              ...
              <div className="space-y-3">
                ...
                <div>
                  <p className="text-sm font-medium text-gray-400 mb-1">
                    Additional RPC Node Requirements
                  </p>
            ...
            <div className="card">
              ...
              <p className="text-sm text-gray-300">
                Not necessary at this time. Operators in the validator community
                do not use GPUs currently.
              </p>
            </div>
          </div>
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td colSpan={2} className="text-gray-300">
                    Not necessary at this time. Operators in the validator
                    community do not use GPUs currently.
                  </td>
                </tr>
              </tbody>
            </table>
